class Chessboard:
    ...
    def startgame(cls, target_board) -> None:
        ...
        target_board.place_piece(white_pawnA, 1, 0)

        white_pawnB = Pawn('White', (1, 1))
        target_board.place_piece(white_pawnB, 1, 1)

        white_pawnC = Pawn('White', (1, 2))
        target_board.place_piece(white_pawnC, 1, 2)

        white_pawnD = Pawn('White', (1, 3))
        target_board.place_piece(white_pawnD, 1, 3)

        white_pawnE = Pawn('White', (1, 4))
        target_board.place_piece(white_pawnE, 1, 4)

        white_pawnF = Pawn('White', (1, 5))
        target_board.place_piece(white_pawnF, 1, 5)

        white_pawnG = Pawn('White', (1, 6))
        target_board.place_piece(white_pawnG, 1, 6)

        white_pawnH = Pawn('White', (1, 7))
        target_board.place_piece(white_pawnH, 1, 7)
        ...
        target_board.place_piece(black_pawnA, 6, 0)

        black_pawnB = Pawn('Black', (6, 1))
        target_board.place_piece(black_pawnB, 6, 1)

        black_pawnC = Pawn('Black', (6, 2))
        target_board.place_piece(black_pawnC, 6, 2)

        black_pawnD = Pawn('Black', (6, 3))
        target_board.place_piece(black_pawnD, 6, 3)

        black_pawnE = Pawn('Black', (6, 4))
        target_board.place_piece(black_pawnE, 6, 4)

        black_pawnF = Pawn('Black', (6, 5))
        target_board.place_piece(black_pawnF, 6, 5)

        black_pawnG = Pawn('Black', (6, 6))
        target_board.place_piece(black_pawnG, 6, 6)

        black_pawnH = Pawn('Black', (6, 7))
        target_board.place_piece(black_pawnH, 6, 7)
